...
- Public API surface is only what `beam_agents/__init__.py` re-exports: `RunAgent`, `AgentConfig`, `tool`, `StreamAgent`, adapter classes. Everything else is private; underscore-prefix internal modules' contents accordingly.
