...
- **WHEN** the suite is collected in an environment where a registered adapter's framework package (e.g. `langgraph` or `pydantic_ai`) is not installed
