...
- [ ] 7.7 `uv run pre-commit run --all-files` clean. — (deferred: the `pre-commit` group is not part of this environment's sync; its ruff/mypy hooks are covered by 7.1/7.2.)
