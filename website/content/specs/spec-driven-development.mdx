...
- [The capability specs](/specs) — the nine published verbatim.
- [Repository scaffolding](/specs/repo-scaffolding) — the gates above, specified.
- [Testing tiers and CI](/docs/testing-and-ci) — what runs where.
- [Contributing](/community/contributing) — how to participate.
- [The API reference](/api) — generated from the installed package, drift-checked.
